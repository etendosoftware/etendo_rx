...
package com.etendorx.lib.asyncprocess.utils;
...
public class KafkaMessageUtil {
  ...
  private void save(AsyncProcessExecution asyncProcessExecution) {
    ...
    send(producer, new ProducerRecord<>(AsyncProcessConstants.ASYNC_PROCESS_EXECUTION, asyncProcessExecution.getAsyncProcessId(), toJson(asyncProcessExecution)));
  }
  ...
  private static String toJson(AsyncProcessExecution asyncProcessExecution) {
    return JsonSerde.OBJECT_MAPPER.writeValueAsString(asyncProcessExecution);
  }
