...
public class GenerateBaseJsonPathConverter extends MappingGenerationBase {
  private static final String FTL_FILE = "/org/openbravo/base/gen/mappings/baseJsonPathConverter.ftl"; // NOSONAR

  public GenerateBaseJsonPathConverter() {
    super(FTL_FILE);
  }
  ...
  protected String getOutFileName(ETRXProjectionEntity etrxProjectionEntity) {
    return etrxProjectionEntity.getTable().getName() + "JsonPathConverter.java";
  }
