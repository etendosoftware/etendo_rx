...
import org.etendorx.dal.core.DalSessionFactory;
...
public abstract class SessionFactoryController {
  ...
  private static final String COLUMN_QUERY_POSTGRES = "SELECT t.tablename, a.attname, a.attnotnull FROM pg_tables t, pg_class c, pg_attribute a " + "WHERE c.relname = t.tablename AND a.attnum > 0 AND a.attrelid = c.oid";

  private static final String COLUMN_QUERY_ORACLE = "SELECT C.TABLE_NAME, C.COLUMN_NAME, C.NULLABLE " + "FROM USER_TAB_COLUMNS C  ORDER BY C.TABLE_NAME";
  ...
  @SuppressWarnings("unchecked") private void addCommonHibernateProperties(Properties properties,
