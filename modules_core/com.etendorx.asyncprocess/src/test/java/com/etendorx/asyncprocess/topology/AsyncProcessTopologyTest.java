...
class AsyncProcessTopologyTest {
  ...
  void setup() {
    ...
    asyncProcessExecutionTopic = testDriver.createInputTopic(AsyncProcessTopology.ASYNC_PROCESS_EXECUTION,
        Serdes.String().serializer(), asyncProcessExecutionJsonSerde.serializer());

    asyncProcessTopic = testDriver.createOutputTopic(AsyncProcessTopology.ASYNC_PROCESS, Serdes.String().deserializer(),
        asyncProcessJsonSerde.deserializer());
  ...
  void testTopology() {
    List.of(
        ...
        .forEach(
            asyncProcessExecution -> asyncProcessExecutionTopic.pipeInput(asyncProcessExecution.getAsyncProcessId(),
