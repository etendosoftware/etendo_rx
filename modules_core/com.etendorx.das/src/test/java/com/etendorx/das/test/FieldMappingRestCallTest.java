...
public class FieldMappingRestCallTest {
  ...
  public static Stream<Arguments> validRequestParams() {
    return Stream.of(
      // Undefined username
      Arguments.of("ADUser", "0", "System", 1, "System Administrator", true),
      Arguments.of("ADUser", "100", "Admin", 13, "QA Testing Admin", false),
      Arguments.of("ADUser", "167450A5BB284AB29C4FEF039E98C963", "F&B ES User", 4, "F&B España, S.A - Sales", false),
      Arguments.of("ADUser", "20C5D31133D949F0BD25412DD1069612", " Rome", 0, null, false),
      Arguments.of("ADUser", "26EF171A1D75485083D276D49AAACD45", "F&BESRSUser", 1, "F&BESRSUser", true),
      Arguments.of("ADUser", "2748452130E84FF0B1A8292D88570F8F", "Joe Matt", 0, null, false),
      Arguments.of("ADUser", "6628F632D484407CBCBD8E71C123A263", "Tom", 0, null, false),
      Arguments.of("ADUser", "D249DE7A14FB4F77BC056A3738A63477", "F&BUSECUser", 1, "F&BUSECUser", true),
      Arguments.of("ADUser", "E12DC7B3FF8C4F64924A98195223B1F8", "F&BUser", 1, "F&BUser", true),
      Arguments.of("ADUser", "4028E6C72959682B01295F40C1D702E6", "John", 0, null, false),
      Arguments.of("ADUser", "4028E6C72959682B01295F40C30F02EA", "Albert", 0, null, false)
      /*
