...
public class RestCallTest {
  ...
  public static Stream<Arguments> validRequestParams() {
    return Stream.of(
        // Undefined username
        Arguments.of("ADUser", "0", "System"), Arguments.of("ADUser", "100", "Admin"),
  ...
  public static Stream<Arguments> invalidRequestParams() {
    return Stream.of(
        // Undefined username
        Arguments.of("123"), Arguments.of("456"), Arguments.of("789"), Arguments.of("0AB"),
        Arguments.of("CDE"), Arguments.of("FGH"), Arguments.of("IJK"), Arguments.of("LMN"),
        Arguments.of("OPQ"), Arguments.of("RST"), Arguments.of("UVW"));
  }
  ...
  public static Stream<Arguments> validBusinessPartnerCategoryName() {
    return Stream.of(
        ...
        Arguments.of("2748452130E84FF0B1A8292D88570F8F", "Moon Light Restaurants, Co.",
            "Customer - Tier 2"),
        ...
        Arguments.of("545A04EE5EF94E9B967536140226793F", "Healthy Food Supermarkets, Co.",
            "Customer - Tier 1"),
        ...
        Arguments.of("6A3D3D6A808C455EAF1DAB48058FDBF4", "Restaurantes Luna Llena, S.A.",
            "Customer - Tier 2"),
        Arguments.of("6B1E8F0CA1524850AB3A7F9AE475A16F", "Alimentos y Supermercados, S.A",
            "Customer - Tier 1"),
        Arguments.of("81FE8AF4E1EF4488B0D92143942C79C3", "Sleep Well Hotels, Co.",
            "Customer - Tier 3"),
        ...
        Arguments.of("CA5D537DFD014F15BFFBA0DB81E1A379", "Hoteles Buenas Noches, S.A.",
            "Customer - Tier 3"),
  ...
  public void whenRestReadBusinessPartnerCategoryName(String id, String businessPartnerName,
      String businessPartnerCategoryName) throws Exception {
    var result = mockMvc.perform(get("/ADUser/" + id + "?projection=test").header(X_TOKEN, TOKEN));
    result.andExpect(MockMvcResultMatchers.status().is2xxSuccessful());
    result.andExpect(
        MockMvcResultMatchers.jsonPath("$.businessPartnerName").value(businessPartnerName));
    result.andExpect(MockMvcResultMatchers.jsonPath("$.businessPartnerCategoryName")
        .value(businessPartnerCategoryName));
  }

  public static Stream<Arguments> validInvoiceLineProjection() {
    return Stream.of(
        Arguments.of("0002165C32244FF382FE46E57C755421", "F8383209982D467EBAA87460953694D1",
            "Zumo de Pera 0,5L"),
        Arguments.of("0004ABE4F2B84554868D0F410F0E92E5", "C970393BDF6C43E2B030D23482D88EED",
            "Zumo de Piña 0,5L"),
        Arguments.of("000A407AC9BE4FB08AEC78577D1E4FA2", "74D47F21C81746239B1A08ECADC98BF1",
            "Rose wine"),
        Arguments.of("0013F39CF44441DD8C62C4810F914323", "BDE2F1CF46B54EF58D33E20A230DA8D2",
            "Agua sin Gas 1L"));
  }

  @ParameterizedTest
  @MethodSource("validInvoiceLineProjection")
  public void whenRestReadInvoiceLineCustomProjection(String id, String invoiceLineProductId,
      String invoiceLineProductName) throws Exception {
    var result = mockMvc.perform(
